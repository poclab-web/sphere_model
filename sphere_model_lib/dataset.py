...
make_dataset("train", "dr.expt.BH3", "train_BH3.xls")
make_dataset("train", "dr.expt.NaBH4", "train_NaBH4.xls")
make_dataset("train", "dr.expt.LiAlH4", "train_LiAlH4.xls")
make_dataset("train", "dr.expt.LiAl(OMe)3H", "train_LiAl(OMe)3H.xls")
make_dataset("train", "dr.expt.MeLi", "train_MeLi.xls")
make_dataset("train", "dr.expt.MeMgI", "train_MeMgI.xls")
make_dataset("train", "dr.expt.PhLi", "train_PhLi.xls")
make_dataset("train", "dr.expt.PhMgI", "train_PhMgI.xls")
